...
CLIENT_UA_MAP: tuple[tuple[str, str], ...] = (
    ...
    # MiniMax ecosystem — MiniMax Code desktop app + embedded opencode
    # runtime. Must come BEFORE the opencode/ entry above so that
    # "MiniMax Code/x.y.z" classifies as minimax-code, not opencode.
